...
API_ID = int(environ.get('API_ID', '26056280'))
API_HASH = environ.get('API_HASH', '22f7162787490ea779835a3257383f01') 
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1991752896').split()]
